...
hold on;
z=R*cos(45*pi/180)+s*cos(t)+i*(R*cos(45*pi/180)+s*sin(t));%坐标为1,3，半径为2,4
G2=my_polar(angle(z),abs(z),'k');
set( G2, 'LineWidth', 3 );
hold on;
...
set( G3, 'LineWidth', 3 );
hold on;
z=-R*sin(5*pi/180)+s*cos(t)+i*(R*cos(5*pi/180)+s*sin(t));%坐标为1,3，半径为2,4
G3=my_polar(angle(z),abs(z),'k');
set( G3, 'LineWidth', 3 );
hold on;
...
set( G4, 'LineWidth', 3 );
hold on;
z=-R*sin(55*pi/180)+s*cos(t)+i*(R*cos(55*pi/180)+s*sin(t));%坐标为1(纵),3(横)，半径为2,4
G4=my_polar(angle(z),abs(z),'k');
set( G4, 'LineWidth', 3 );
hold on;
...
set( G5, 'LineWidth', 3 );
hold on;
z=-R*cos(15*pi/180)+s*cos(t)+i*(-R*sin(15*pi/180)+s*sin(t));%坐标为1(纵),3(横)，半径为2,4
G4=my_polar(angle(z),abs(z),'k');
set( G4, 'LineWidth', 3 );
hold on;
...
set( G1, 'LineWidth', 3 );
hold on;
z=s*cos(t)+i*(s*sin(t));%坐标为1,3，半径为2,4
G1=my_polar(angle(z),abs(z),'k');
set( G1, 'LineWidth', 3 );
hold on;
