...
set( G2, 'LineWidth', 3 );
hold on;
G6 =my_polar([0,20*pi/180],[0,80],'r-');%画直线
set( G6, 'LineWidth', 3 );
hold on;
%绘制护卫舰位置
...
y=0;
G10=my_polar(x,y,'*b');
set( G10, 'markersize', 15 , 'LineWidth', 15);
hold on;
...
G7 =my_polar([220*pi/180,220*pi/180],[3.5,80],'r-');%画直线
set( G7, 'LineWidth', 3 );
hold on;


%绘制护卫舰点连线
x= [20*pi/180 45*pi/180 95*pi/180 145*pi/180 195*pi/180 220*pi/180];
y=[43.3240 R R R R 43.3240];
G8=my_polar(x,y,'b');
set( G8, 'LineWidth', 2 );
